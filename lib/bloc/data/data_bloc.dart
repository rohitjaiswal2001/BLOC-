  ...
  DataBloc() : super(DataInitial()) {
    on<FetchDataEvent>((event, emit) async {
      ...
      try {
        ...
        // Let's pretend sometimes the internet fails randomly
        // final bool simulateError = DateTime.now().second % 2 == 0;
        // if (simulateError) throw Exception("No internet connection!");
